...
cd ./prysm_mev_4 && go build -o=../validator-test4 ./cmd/validator
cd ..
# cd ./prysm_mev_5 && go build -o=../validator-test5 ./cmd/validator
# cd ..
# cd ./prysm_mev_6 && go build -o=../validator-test6 ./cmd/validator
# cd ..



echo "===========Start execution layer================"
./prysmctl testnet generate-genesis --fork capella --num-validators 1200 --genesis-time-delay 80 --chain-config-file config.yml --geth-genesis-json-in genesis.json  --geth-genesis-json-out genesis.json --output-ssz genesis.ssz
...
nohup ./validator-test0 --datadir validatordatafiles/validatordata_1 --accept-terms-of-use --interop-num-validators 42 --interop-start-index=0 --chain-config-file config.yml --beacon-rpc-provider=127.0.0.1:4001 --grpc-gateway-port=3501 --verbosity debug &> Log/val_1.log &
...
nohup ./validator-test4 --datadir validatordatafiles/validatordata_2 --accept-terms-of-use --interop-num-validators 18 --interop-start-index=42 --chain-config-file config.yml --beacon-rpc-provider=127.0.0.1:4002 --grpc-gateway-port=3502 --verbosity debug &> Log/val_2.log &
...
nohup ./validator-test1 --datadir validatordatafiles/validatordata_3 --accept-terms-of-use --interop-num-validators 30 --interop-start-index=60 --chain-config-file config.yml --beacon-rpc-provider=127.0.0.1:4003 --grpc-gateway-port=3503 --verbosity debug &> Log/val_3.log &
...
nohup ./validator-test1 --datadir validatordatafiles/validatordata_4 --accept-terms-of-use --interop-num-validators 170 --interop-start-index=90 --chain-config-file config.yml --beacon-rpc-provider=127.0.0.1:4004 --grpc-gateway-port=3504 --verbosity debug &> Log/val_4.log &
...
nohup ./validator-test1 --datadir validatordatafiles/validatordata_5 --accept-terms-of-use --interop-num-validators 100 --interop-start-index=260 --chain-config-file config.yml --beacon-rpc-provider=127.0.0.1:4005 --grpc-gateway-port=3505 --verbosity debug &> Log/val_5.log &
...
nohup ./validator-test2 --datadir validatordatafiles/validatordata_6 --accept-terms-of-use --interop-num-validators 3 --interop-start-index=360 --chain-config-file config.yml --beacon-rpc-provider=127.0.0.1:4006 --grpc-gateway-port=3506 --verbosity debug &> Log/val_6.log &
...
nohup ./validator-test2 --datadir validatordatafiles/validatordata_7 --accept-terms-of-use --interop-num-validators 57 --interop-start-index=363 --chain-config-file config.yml --beacon-rpc-provider=127.0.0.1:4007 --grpc-gateway-port=3507 --verbosity debug &> Log/val_7.log &
...
nohup ./validator-test3 --datadir validatordatafiles/validatordata_8 --accept-terms-of-use --interop-num-validators 300 --interop-start-index=420 --chain-config-file config.yml --beacon-rpc-provider=127.0.0.1:4008 --grpc-gateway-port=3508 --verbosity debug &> Log/val_8.log &
...
nohup ./validator-test3 --datadir validatordatafiles/validatordata_9 --accept-terms-of-use --interop-num-validators 300 --interop-start-index=720 --chain-config-file config.yml --beacon-rpc-provider=127.0.0.1:4009 --grpc-gateway-port=3509  --verbosity debug &> Log/val_9.log &
...
nohup ./validator-test3 --datadir validatordatafiles/validatordata_10 --accept-terms-of-use --interop-num-validators 180 --interop-start-index=1020 --chain-config-file config.yml --beacon-rpc-provider=127.0.0.1:4010 --grpc-gateway-port=3510 --verbosity debug &> Log/val_10.log &
